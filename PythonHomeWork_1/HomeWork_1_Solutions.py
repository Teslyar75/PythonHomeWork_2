...
def analyze_students(students_dict):
    ...
    # Повертаємо кортеж: (словник середніх балів, (кращий студент, його макс. 
    # оцінка))
...
def count_characters(text):
    ...
    for char in text:
        # get(char, 0) - повертає поточну кількість символу (або 0, якщо 
        # символу немає)
        # +1 - збільшуємо лічильник на 1
        # Ця техніка дозволяє безпечно працювати з словником без 
...
def sort_by_length(strings):
    ...
    # len() повертає довжину рядка, тому рядки будуть відсортовані від коротших 
    # до довших
    #
    # Приклади:     
    # sorted(["abc", "a", "ab"], key=len) --> ["a", "ab", "abc"]
    # sorted(["Python", "is", "awesome"], key=len) --> ["is", "Python", 
    # "awesome"]
    #
